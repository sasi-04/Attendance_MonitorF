...
export default function StudentDashboard() {
  ...
  const stats = [
    ...
    { label: 'Present Today', value: 1120 },
  ...
  const recentActivity = [
    { name: 'You', time: '08:45 AM', status: 'Checked In' },
    { name: 'Classmate A', time: '08:43 AM', status: 'Checked In' },
    { name: 'Classmate B', time: '08:40 AM', status: 'Checked In' },
  ]
